...
- [x] [node](https://github.com/nodejs/node) server backend;
...
2. download this folder by clicking [this link](https://download-directory.github.io/?url=https://github.com/lucasvtiradentes/boilermanager-boilerplates/tree/master/boilerplates/node/node-basic)
<!-- </DYNFIELD:boilerplate_project_download> -->
