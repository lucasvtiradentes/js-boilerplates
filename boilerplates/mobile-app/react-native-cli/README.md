...
- [x] [react native](https://reactnative.dev/docs/environment-setup) cli application;
...
2. download this folder by clicking [this link](https://download-directory.github.io/?url=https://github.com/lucasvtiradentes/boilermanager-boilerplates/tree/master/boilerplates/mobile-app/react-native-cli)
<!-- </DYNFIELD:boilerplate_project_download> -->
